    ...
    for cnt in contours:
        ...
        if area > areaMin:
            ...
            if (cx < int(frameWidth / 2) - deadzone):
                cv2.putText(imgContour, " GO LEFT ", (20, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 225), 3)
                ...
                cv2.putText(imgContour, " GO RIGHT ", (20, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 225), 3)
                ...
                cv2.putText(imgContour, " GO UP ", (20, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 225), 3)
                cv2.rectangle(imgContour, (int((frameWidth / 2) - deadzone), 0),
                              (int((frameWidth / 2) + deadzone), int((frameWidth / 2) - deadzone)),
                              (0, 0, 255), cv2.FILLED)
            elif cy < int((frameHeight / 2) + deadzone):
                cv2.putText(imgContour, " GO DOWN ", (20, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 225), 3)
                cv2.rectangle(imgContour, (int((frameWidth / 2) - deadzone), int((frameWidth / 2) - deadzone)),
...
while True:
    ...
    cv2.imshow('Horizontal Stacking', stack)  # WHY
